  ...
  while [(i < number)] [
    ask one-of patches with [water = true ] [
        sprout 1 [
          ...
          set mass 1
          set life-stage 1
          set energy random-normal 5.5 E-stderr
...
to hatch-eggs
  if time-to-hatch? and life-stage = 0 [set egg false set life-stage 1 set size 1 set shape "caterpillar" move-to one-of water-patches set color brown set can-lay-eggs false
                                           set mass 1 set energy random-normal 5.5 E-stderr set metabolism (metabolism-rate * mass) set JM1 random 100 set JM2 random 100  set hatch-time ticks set age 0]
end
...
<experiments>
  ...
  <experiment name="stochastic_energyl_late" repetitions="25" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <exitCondition>total-mosquito-number = 0</exitCondition>
    ...
    <enumeratedValueSet variable="e-stderr">
      <value value="1"/>
      <value value="3"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="stochastic_energy_early" repetitions="25" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <exitCondition>total-mosquito-number = 0</exitCondition>
