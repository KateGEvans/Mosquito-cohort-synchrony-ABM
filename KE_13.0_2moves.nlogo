...
<experiments>
  ...
  <experiment name="stochstic_movementl_early" repetitions="25" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <exitCondition>total-mosquito-number = 0</exitCondition>
  ...
  <experiment name="stochstic_movementl_late" repetitions="25" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <exitCondition>total-mosquito-number = 0</exitCondition>
